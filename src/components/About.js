   ...
   <div className="aboutContainer">
    <div className="aboutInfo" data-aos="fade-right">
     <p>
      ...
      <br></br>
      <br></br>
      Over 3+ years. I had the opportunity to work in a vast spectrum of web technologies which let me get experience in
      user interface, testing, debugging, deployment, and numerous other full-stack technologies. This helped me build
      numerous websites for start-ups and businesses.
      <br></br>
